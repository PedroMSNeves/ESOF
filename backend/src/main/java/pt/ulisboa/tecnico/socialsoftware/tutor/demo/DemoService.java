...
public class DemoService {
    ...
    public void NewPopulateDemo() {
        ...
        StudentStats st1 = new StudentStats();
        //StudentStats st1 = studentStatsRepository.findById();
        st1.setNumStudents(5);
        st1.setNumMore75CorrectQuestions(0);
        st1.setNumAtLeast3Quizzes(2);

        StudentStats st2 = new StudentStats();
        st2.setNumStudents(7);
        st2.setNumMore75CorrectQuestions(1);
        st2.setNumAtLeast3Quizzes(3);

        StudentStats st3 = new StudentStats();
        st3.setNumStudents(21);
        st3.setNumMore75CorrectQuestions(10);
        st3.setNumAtLeast3Quizzes(21);

        studentStatsRepository.save(st1);
        studentStatsRepository.save(st2);
        studentStatsRepository.save(st3);
